function horizontal_Vector_of_amplitude = Phase_Element ( horizontal_Vector_of_a_Single_subRegion )
    ...
    %% Section 1: Extraction of Amplitude
        horizontal_Vector_of_amplitude = angle(horizontal_Vector_of_a_Single_subRegion);
